...
import com.sammy.etweaks.activities.BannerResizerActivity;
import com.sammy.etweaks.activities.MainActivity;
import com.sammy.etweaks.activities.NavigationActivity;
import com.sammy.etweaks.services.boot.ApplyOnBootService;
import com.sammy.etweaks.utils.AppSettings;
import com.sammy.etweaks.utils.Themes;
...
import com.sammy.etweaks.views.BorderCircleView;
    ...
    private void resetDataDialog(){
        ...
        alert.setPositiveButton(getString(R.string.ok), (dialog, id) -> {
            ...
            alert2.setNegativeButton(getString(R.string.cancel), (dialogInterface, i) -> {
                ...
                RootUtils.runCommand("pm clear com.sammy.etweaks");
            });
            alert2.setPositiveButton(getString(R.string.ok), (dialog1, id1) -> {
                RootUtils.runCommand("rm -rf /data/.mtweaks");
                RootUtils.runCommand("pm clear com.sammy.etweaks && reboot");
            });
            alert2.show();
        });
        alert.show();
